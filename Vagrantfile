...
Vagrant.configure(2) do |config|
  ...
  config.vm.hostname = "soa12213-dev.esentri.com"
  ...
  config.vm.network "forwarded_port", guest: 7201, host: 7201
  ...
  config.vm.provider "virtualbox" do |vb|
    vb.gui = false
    vb.name = "Oracle SOA Development 12.2.1.3"
    vb.memory = "6144"
    vb.cpus = 1
  end
  #
  ...
  config.vm.provision "shell" do |s|
    ...
    s.env = {ORACLE_BASE: "/opt/oracle",
             ...
             JAVA_MD5: "a58eab1ec242421181065cdc37240b08"}
  end
end
